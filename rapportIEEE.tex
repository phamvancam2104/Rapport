...
\lstset{ %
	...
	otherkeywords={*,STATE,STATE\_MACHINE,INITIAL, INITIAL\_STATE, FINAL\_STATE, CHOICE, EXIT\_POINT, TRANSITION\_TABLE, TRANSITION, SHALLOW\_HISTORY, TABLE, FINAL,...},           % if you want to add more keywords to the set
...
%
%
\title{Mid-term report: Approaches for integrating Model-Driven Engineering into industrial practice}
%
%
\author{
